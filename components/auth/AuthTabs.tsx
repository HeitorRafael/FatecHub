        ...
        <div className="w-full max-w-md">
            ...
            <div className="flex gap-2 mb-6">
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${activeTab === 'login'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${activeTab === 'register-estudante'
                            ? 'bg-blue-600 text-white'
                            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                        }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${activeTab === 'register-empresa'
                            ? 'bg-blue-600 text-white'
                            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                        }`}
                >
